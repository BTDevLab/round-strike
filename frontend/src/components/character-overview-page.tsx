    ...
    <div className="flex flex-col min-h-screen bg-gradient-to-b from-slate-900 via-purple-900 to-slate-900 text-white">
      <main className="flex-1 p-4 md:p-8">
        <div className="max-w-6xl mx-auto">
            ...
            <CardHeader>
              <div className="flex items-center gap-6">
                ...
                <div className="flex-1">
                  <CardTitle className="text-2xl text-white">Chafundiffornio</CardTitle>
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
                    {inventory.map((item) => (
                      <Card
                        ...
                        onClick={() => item.type !== 'consumable' && equipItem(item.id)}
                      >
                        <CardContent className="p-4">
                          ...
                          {item.damage && (
                            <p className="text-red-400 text-xs">Damage: {item.damage}</p>
                          )}
                          {item.defense && (
                          ...
                          {item.effect && (
                            <p className="text-gray-400 text-xs mt-1">{item.effect}</p>
                          )}
                        </CardContent>
                      </Card>
                    ))}
          ...
          <Card className="bg-gradient-to-br from-purple-900/50 to-pink-900/50 border-purple-500/30 mt-4">
